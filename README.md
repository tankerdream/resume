...
- 具有发现问题的强烈欲望，较强的分析、解决issue的能力
- 具有一定的项目策划和管理经验，能够客观分析项目状况和外部环境，及时作出决策并协助团队调整
- 擅长跟踪发现科技领域的新理论、新技术和新产品，很强的快速学习和自我适应能力
...
- 熟悉 JStorm、MapReduce编程模型，了解微服务架构及etcd、Kafka等相关技术，**阅读过Storm源码**并受邀重构JStorm代码
...
- 想听音乐社交网站（2015.12）`项目负责人` `2人`

  > 音乐社交网站，包括排行榜、碎片（留言）、轻博客、音乐播放等功能。

  - **1周内完成网站**的策划、开发、上线，完成**任务分解和时间计划**，负责开发后台模块
  - 积累了**紧急任务的应对经验**，提高了**快速响应、火速执行**的能力


- 阿里巴巴移动推荐算法大赛（2015.05 - 2015.06）`算法实现` `3人`
...
- SmartC智能日历iOS应用（2014.10 - 2014.12 ）`个人项目`
  ...
  - 调研校园活动发布的传统流程，**提出更优解决方案，详细制定执行方案**
  - 部署SAE环境， 开发实现后台、Web和移动端
  - 实现主题日程快速添加，**降低**学生日程**管理成本**，**促进活动分享宣传**
...
- 微信会员卡（2014.04 - 2014.06 ）`个人项目`
  ...
  - 实现后端到前端的整个流程，了解到开发中**不同模块的协调、对接等技术层面的问题**
  - 通过公众号的开放模式和实现机制认识到**平台产品要在灵活与易用、开放与封闭之间寻求平衡点**
